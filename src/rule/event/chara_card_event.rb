...
module Unlight
  ...
  CHARA_FEAT_EVENT_NO = [
    ...
    # 22
    %i[check_add_hi_rapid_sword_feat_event
    ...
    # 32 光の移し身
    %i[check_add_seal_chain_feat_event
    ...
    # 55 2つの身体
    %i[check_add_nine_soul_feat_event
    ...
    # 57 13の眼
    %i[check_add_life_drain_feat_event
    ...
    # 95 ヘルズベル
    %i[check_add_whirl_wind_feat_event
    ...
    # 101 ハイハンド
    %i[check_add_jack_pot_feat_event
    ...
    # 107 ブラストオフ
    %i[check_add_puppet_master_feat_event
